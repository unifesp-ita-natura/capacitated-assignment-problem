...
from src.forecasting.model import forecast_next_cycle, forecast_with_shape
...
def test_forecast_next_cycle_returns_calendar_mapped_forecast_for_expected_sectors():
    ...
    assert "forecast_orders" in forecast.columns
    assert "order_date" in forecast.columns
