...
def test_build_cd_sector_shares_inverts_sector_to_cd_maps(sectors):
    sector_ids, _ = build_id_maps(sectors)
    shares = {"S01": {2700: 1.0}, "S02": {2700: 0.7, 5300: 0.3}}

    cd_sector_shares = build_cd_sector_shares(shares, sector_ids)

    assert cd_sector_shares == {
        2700: {sector_ids["S01"]: 1.0, sector_ids["S02"]: 0.7},
        5300: {sector_ids["S02"]: 0.3},
    }
